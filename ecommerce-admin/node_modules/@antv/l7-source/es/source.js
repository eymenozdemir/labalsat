...
var Source = /*#__PURE__*/function (_EventEmitter) {
  ...
  _createClass(Source, [{
    ...
    value: function reloadTileByExtent(bounds, z) {
      var _this$tileset4;
      (_this$tileset4 = this.tileset) === null || _this$tileset4 === void 0 ? void 0 : _this$tileset4.reloadTileByExtent(bounds, z);
    }
  }, {
    key: "destroy",
    value: function destroy() {
      ...
      // @ts-ignore
      this.data = null;
      (_this$tileset5 = this.tileset) === null || _this$tileset5 === void 0 ? void 0 : _this$tileset5.destroy();
    }
  }, {
    key: "processData",
    value: function () {
